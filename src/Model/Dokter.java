...
public class Dokter {
    ...
    /**
     * membuat constructor untuk mendeklarasikan objek Dokter
     */
    public Dokter() {
    ...
    /**
     *membuat  constructor untuk mendeklarasikan objek Dokter dengan parameter lokal
     * nama dengan tipe data String
     *
     * @param nama
     */
    public Dokter(String nama) {
        // pernyataan bahwa nilain variabel nama yang bersifat global sama dengan nilai dari variabel lokal nama
        this.nama = nama;
    }
    ...
    public void setNomorPegawai(String nomorPegawai) throws Exception {
        ...
        if (nomorPegawai.length() == 5) {
            //pernyataan bahwa nilai variabel nomorPegawai yang bersifat global sama dengan nilai dari variabel lokal nomorPegawai ditambah 3 huruf awal dari variabel nama
    ...
    public void setTempatLahir(String tempatLahir) {
        // pernyataan bahwa nilai dari variabel tempatLahir yang bersifat global sama dengan nilai dari variabel lokal tempatLahir
    ...
    public void setTanggalLahir(int tanggalLahir) throws Exception {
        ...
        if (tanggalLahir > 0) {
            ...
            if (tanggalLahir <= 31) {
                //pernyataan bahwa nilai dari variabel tanggalLahir yang bersifat global sama dengan nilai dari variabel lokal tanggalLahir
    ...
    public void setBulanLahir(int bulanLahir) throws Exception {
        ...
        if (bulanLahir > 0) {
            ...
            if (bulanLahir <= 12) {
                //pernyataan bahwa nilai dari variabel bulanLahir yang bersifat global sama dengan nilai dari variabel lokal bulanLahir
    ...
    public void setTahunLahir(int tahunLahir) throws Exception {
        ...
        if (tahunLahir > 0) {
            //pernyataan bahwa nilai dari variabel tahunLahir yang bersifat global sama dengan nilai dari variabel lokal tahunLahir
